...
export default function Auth() {
  ...
  return (
    <Layout>
      {/* relative container for card + badge */}
      <div className="relative max-w-md mx-auto mt-12">
        ...
        {/* Developed by badge */}
        <div className="absolute bottom-2 right-2 bg-black bg-opacity-60 text-white text-xs font-medium px-2 py-1 rounded-lg shadow">
